...
public class FunctionDao {
	...
	public void publish_video(Map<String, String> map) throws SQLException {
		...
		String video_uploadnumber = map.get("video_uploadnumber");
		Date date = new Date();			//characte为0时标识教师，为1时标识管理员
		Timestamp uploadtime = new Timestamp(date.getTime()); //发布时间
		...
		int video_playnum = 0;
		Object[] params = {video_id,video_name,video_oldattachment,video_attachment,uploadtime,video_uploaduser,video_uploadnumber,video_pro,video_character,video_playnum,video_savepath};
	...
	public void publish_document(Map<String, String> map) throws SQLException {
		...
		String document_uploadnumber = map.get("document_uploadnumber");
		...
		Object[] params = {document_id,document_name,document_oldattachment,document_attachment,uploadtime,document_uploaduser,document_uploadnumber,document_pro,document_character,document_downloadnum,document_savepath};

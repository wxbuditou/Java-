...
<div class="container">
  ...
  <div class="content">
   ...
   <tr>
   <td colspan="4">
    <span style="text-align:center;display:block;width=750">${news.news_topic } &nbsp;${news.news_uploaduser}</span>
    </td>
    </tr>
    <tr>
    <td>
    <span style="width:750px;height:500px;">${news.news_content}</span>
    </td>
 	</tr>
    </table>
    </div>

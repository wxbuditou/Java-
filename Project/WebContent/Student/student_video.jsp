  ...
  <div class="content">
    ...
    <c:forEach items="${page.list}" var="video" varStatus="idStatus">
     <tr>		
      ...
      <td><a href="${pageContext.request.contextPath }/Student/StudentServlet?method=show_video&video_id=${video.video_id}">${video.video_name}</a></td>	

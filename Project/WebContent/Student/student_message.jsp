...
<div class="container">
  ...
  <div class="content">
    <table width="764" border="0">
     ...
     <tr>
     <td>
     <a href="student_publish_message.jsp">提问</a>
    <div class="interact_num">
    <table width="750" border="0">
    <tr>
    <c:forEach items="${page.list}" var="message" varStatus="idStatus">
     <tr>		
      <td>${idStatus.count}</td>
      <td><a href="${pageContext.request.contextPath }/Student/StudentServlet?method=show_message&message_id=${message.message_id}">${message.message_topic}</a></td>	

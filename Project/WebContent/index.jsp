...
.bg_topic{
	background-image: url(Image/projectname.png);
	height:120px;
...
<body background="">
<div id="container" style="margin:auto;margin-top:5%; background:200080;" class="container">
<div class="bg_topic" ></div>
<div class="loginwindow" style=" margin:auto; width:403px;height:302px;;">
<div class="window" style=" padding-top:20px; padding-left:5px; padding-right:5px;">
<div class="denglu"><p align="center" style="font-size:16px; margin-top:5px;"><strong>登     陆</strong></p></div>
...
<form action="UserServlet" method="post" id="fm">
		用户名：
    <input type="text" name="username" id="username" style=" width:245px; height:37px; font-size:28px" class="user"> 
	<select name="position" style="height:37px; width:50px;">
...
<br>
			密&nbsp;&nbsp;&nbsp;码：	
    <input type="password" name="password" id="password" style="  width:245px; height:37px;font-size:28px" class="password">
	<br>
	<div >
	验证码：<input type="text" name="code" id="code" style="  width:125px; height:37px; vertical-align:middle;font-size:28px">
	<img src="servlet/CheckCodeServlet" style="vertical-align:middle"></div><br>

...
<div class="container">
  ...
  <div class="content">
   ...
   <p>上传文件</p>
       <form action="TeacherServlet?method=publish_document" enctype="multipart/form-data" method="post" id="fm">
       <div style="margin-left:250px">
	文件名称:
	  <input type="text" name="document_name" id="name"><br/>
	选择文件:
	<input type="file" name="document_attachment" id="file"><br/>
	视频描述:
	<input type="text" name="document_pro"><br/>
